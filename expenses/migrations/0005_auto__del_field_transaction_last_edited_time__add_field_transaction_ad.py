...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.last_edited_time'
        db.delete_column(u'expenses_transaction', 'last_edited_time')

        # Adding field 'Transaction.add_date'
        db.add_column(u'expenses_transaction', 'add_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Transaction.last_edited_time'
        db.add_column(u'expenses_transaction', 'last_edited_time',
                      self.gf('django.db.models.fields.TimeField')(auto_now=True, default=datetime.time(0, 0), blank=True),
                      keep_default=False)
