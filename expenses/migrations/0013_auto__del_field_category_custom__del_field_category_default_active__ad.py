...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'expenses_category', 'is_active',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'expenses_category', 'is_active')
    ...
    models = {
        ...
        u'expenses.transaction': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 16, 0, 0)'}),
