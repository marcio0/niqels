...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.installment_number'
        db.add_column(u'expenses_transaction', 'installment_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SplitTransaction.description'
        db.add_column(u'expenses_splittransaction', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.installment_number'
        db.delete_column(u'expenses_transaction', 'installment_number')

        # Deleting field 'SplitTransaction.description'
        db.delete_column(u'expenses_splittransaction', 'description')
    ...
    models = {
        ...
        u'expenses.transaction': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
