            ...
            return this.each(function() {
                ...
                function keypressEvent(e) {
                    ...
                    if (k < 48 || k > 57) { // any key except the numbers 0-9
                        if ((k == 45) || (k == 43)) { // -(minus) key
                            markAsDirty();
                            s = (k == 45) ? '-' : '+';
                            input.val(changeSign(input, s));
                            return false;
                ...
                function maskValue(v) {
                    ...
                    if(settings.allowNegative){
                        if(settings.negativeDefault){
                            if(len != 0 && v.charAt(0)=='0'){
                                syn = '-';
                            }
                        }
                        if(len != 0 && v.charAt(0)=='-'){
                    ...
                    ? setSymbol(syn+t+settings.decimal+d+Array((settings.precision+1)-d.length).join(0))
                    : setSymbol(syn+t);
                }
                ...
                function changeSign(input, s){
                    var inputValue = input.val();
                    if (settings.allowNegative){
                        if (inputValue != '' && inputValue.charAt(0) == '-'){
                            return inputValue.replace('-', s);
                        } else if (inputValue != '' && inputValue.charAt(0) == '+'){
                            return inputValue.replace('+', s);
                        } else {
                            return s + inputValue;
                        }
