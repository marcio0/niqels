...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RepeatableTransaction.category'
        db.delete_column(u'reminder_repeatabletransaction', 'category_id')

        # Adding field 'RepeatableTransaction.category_config'
        db.add_column(u'reminder_repeatabletransaction', 'category_config',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'RepeatableTransaction.category'
        raise RuntimeError("Cannot reverse this migration. 'RepeatableTransaction.category' and its values cannot be restored.")
        # Deleting field 'RepeatableTransaction.category_config'
        db.delete_column(u'reminder_repeatabletransaction', 'category_config_id')
